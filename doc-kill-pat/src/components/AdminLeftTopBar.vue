<template>
    <div :="topBar">牙 医 病 历 系 统（维护）</div>
    <div :="leftBar">
        <div :="leftBarNavi" ><img src="../assets/imgs/navi.png" style="width:2vw">&nbsp;导&nbsp;航
        </div>
        <div :="leftBarCon1"><img src="../assets/imgs/adminParLogo.png" style="width:1.8vw;margin-right: 1vw;">
            <p :="leftBarText1" @click="gotoOperDepart">疾病管理</p>
        </div>
        <div :="leftBarCon2"><img src="../assets/imgs/adminDocLogo.png" style="width:1.8vw;margin-right: 1vw;">
            <p :="leftBarText2" @click="gotoOperDoctor">医生管理</p></div>
        <div :="leftBarCon3"><img src="../assets/imgs/adminPatLogo.png" style="width:1.8vw;margin-right: 1vw;"><router-link
                to="/admin/adminOperPat" :="leftBarText3">病人管理</router-link></div>
        <div :="leftBarCon4"><img src="../assets/imgs/adminDruLogo.png" style="width:2vw;margin-right: 1vw;"><router-link
                to="/admin/adminOperDrug" :="leftBarText4">药品管理</router-link></div>
        <div :="leftBarCon5"><img src="../assets/imgs/adminDeLogo.png" style="width:2vw;margin-right: 1vw;"><router-link
                to="/admin/adminOperDevice" :="leftBarText5">设备管理</router-link></div>
    </div>
    <div :="rightUser" >
        <img src="../assets/imgs/headImg.png" style="width:2.5vw;margin-right: 1vw;pointer-events: none;">
        <p :="rightUserText" @click="adminInfo">管理员</p>
        <!-- <input> -->
    </div>
    <div :="rightUser" >
